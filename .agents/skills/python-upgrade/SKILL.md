...
2. **Invoke Verifier**: Use the `verifier` subagent ([../../../.claude/agents/verifier.md](../../../.claude/agents/verifier.md)) to run the full build, lint, and test cycle (e.g., `make lint`, `make test`, `make build`).
